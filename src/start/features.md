...
| `serde`             |    yes    | enables serialization/deserialization via `serde` (pulls in the [`serde`](https://crates.io/crates/serde) crate);<br/><br/>[`smartstring/serde`][`smartstring`] must be manually enabled due to a bug that prevents it from being used in [`no-std`]               |
...
| `grain`             |    yes    | enables the _experimental_ **[Rhai Grain]** [bytecodes][bytecodes-wiki] transpiler and VM (work-in-progress)                                                                                                                                                       |
...
| `grain`             |    yes    | enables the experimental [Rhai Grain VM] bytecode compiler and VM                                                                                                                                                                                                  |
