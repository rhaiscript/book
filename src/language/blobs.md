...
| `splice`                                                | <ol><li>[range] of bytes to remove, from beginning if ≤ 0, to end if ≥ length</li><li>BLOB to insert</li></ol>                                                                                                      | replaces a portion of the BLOB with another (not necessarily of the same length as the replaced portion)                                             |
