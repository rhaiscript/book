...
| `drain`                   | 1) start position, counting from end if < 0, end if ≥ length<br/>2) number of items to remove, none if ≤ 0                                                              | removes a portion of the array, returning the removed items                                                                                                                                                               |
...
| `retain`                  | 1) start position, counting from end if < 0, end if ≥ length<br/>2) number of items to retain, none if ≤ 0                                                              | retains a portion of the array, removes all other items and returning them                                                                                                                                                |
