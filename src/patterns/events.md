...
| Local [variable] may _shadow_ state [variable]? |                                                 yes                                                 |                                     no                                      |                                 yes                                  |
| Benefits                                        |                                               simple                                                |                               fewer surprises                               |                              versatile                               |
| Disadvantages                                   | &bull; no new variables in [functions] (apart from `init`)<br/>&bull; easy variable name collisions | &bull; `this.xxx` all over the place<br/>&bull; more complex implementation | &bull; `state.xxx` all over the place<br/>&bull; inconsistent syntax |
