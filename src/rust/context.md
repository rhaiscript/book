...
| `namespaces()`            | [`internals`],<br/>not [`no_function`] |                [`&[&Module]`][`Module`]                | reference to the [namespaces][function namespaces] (as [modules]) containing all script-defined [functions]                                                                                                                                |
